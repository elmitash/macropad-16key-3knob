(() => {
  ...
  var STRINGS = {
    ...
    "led.writeHint": {
      en: 'Click "Write to device" to save. (Reconnecting USB is required to apply changes to physical LEDs)',
    ...
    "wr.done": {
      en: "Wrote {n} changes to the device. (Please unplug and replug USB to reflect new LED modes)",
